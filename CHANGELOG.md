...
- Restore explicit opt-in Microsoft Clarity analytics with a first-visit consent banner, ConsentV2 signaling, advertising storage disabled, and customer-specific workflow masking.
